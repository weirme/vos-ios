...
let K_indicatorViewMidX: CGFloat = K_scrollViewX + K_scrollViewWidth * 0
...
let scrollViewX = screenWidth * K_scrollViewX
let scrollViewWidth = screenWidth * K_scrollViewWidth
let scrollViewContentWidth = scrollViewWidth * 0.7
let scrollViewStandardOffset: CGFloat = screenWidth * K_scrollViewOffset

let timeTolerance: CMTime = CMTime(value: 1, timescale: 15)
